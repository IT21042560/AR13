...
import { MTLLoader } from "https://cdn.skypack.dev/three@0.129.0/examples/jsm/loaders/MTLLoader.js"; // Import MTLLoader
...
// Load the .mtl file
mtlLoader.load(
  'models/model.mtl', // Ensure this path is correct
  function (materials) {
    ...
    objLoader.load(
      ...
      function (obj) {
        ...
        object.scale.set(1, 1, 1); // Adjust the scale
